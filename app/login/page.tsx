        ...
        >
          <span className="flex h-6 w-6 items-center justify-center rounded-full bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4">
              <path fill="#EA4335" d="M12 10.2v3.7h5.2c-.2 1.2-.8 2.2-1.7 2.9l2.7 2.1c1.6-1.5 2.5-3.7 2.5-6.3 0-.6-.1-1.1-.2-1.6H12z" />
              <path fill="#34A853" d="M6.6 14.3l-.9.7-2.2 1.7C5 19.4 8.2 21 12 21c2.6 0 4.8-.9 6.4-2.4l-2.7-2.1c-.7.5-1.6.9-2.7.9-2.1 0-3.9-1.4-4.6-3.3z" />
              <path fill="#4A90E2" d="M4.5 8.7 2.3 7C1.5 8.1 1 9.5 1 11s.5 2.9 1.3 4l3.3-2.6A4.8 4.8 0 0 1 5.8 12c0-.7.1-1.3.3-1.9z" />
