...
export default function ClientNav() {
  ...
  return (
    <header className="mb-6 rounded-2xl border border-neutral-800 bg-[#060606] px-4 py-3">
      ...
      >
        <NavItem href="/client" label="Home" onNavigate={() => setMenuOpen(false)} />
        <NavItem href="/businesses" label="Businesses" onNavigate={() => setMenuOpen(false)} />
        <NavItem href="/client/reservations" label="My reservations" onNavigate={() => setMenuOpen(false)} />
        <NavItem href="/client/profile" label="Profile" onNavigate={() => setMenuOpen(false)} />
      </nav>
    </header>
  );
}
